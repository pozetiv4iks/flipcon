        ...
        <main className="max-w-4xl mx-auto w-full p-12">
          <header className="mb-12">
            <div className="flex items-center gap-4 mb-2">
              ...
              <h1 className="text-[32px] font-bold">Настройки</h1>
            </div>
            <p className="text-white/40">Управляйте своим аккаунтом и внешним видом приложения</p>
          </header>
              ...
              {[
                ...
                <button 
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-[15px] font-medium transition-all ${
                    item.id === "appearance" ? "bg-white/5 text-white" : "text-white/40 hover:text-white/60"
                  }`}
                >
                  <item.icon size={18} />
            ...
            <div className="space-y-12">
              <section>
                ...
                <p className="text-white/40 text-[14px] mb-8">
                  Выберите основной цвет фона для вашего пространства. Это изменит радиальный градиент и цвет сайдбара на всех страницах.
                </p>
                ...
                <div className="bg-white/[0.02] border border-white/5 rounded-[32px] p-8">
                  ...
                  <div className="mt-8 flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5">
                    ...
                    <div>
                      <p className="text-[14px] font-medium">Текущий оттенок</p>
              ...
              <section>
                ...
                <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-6 space-y-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-[12px] font-bold text-white/20 uppercase tracking-widest mb-1">Имя пользователя</p>
                      <p className="text-[15px]">Stepan Dyleuski</p>
                    </div>
                    <button className="text-[13px] text-blue-400 hover:underline">Изменить</button>
                  </div>
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-[12px] font-bold text-white/20 uppercase tracking-widest mb-1">Email</p>
